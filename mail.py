...
def first_prize_body(event_name, username):
    return f"Dear {username},\n\nWe are thrilled to inform you that you have been selected as the first prize winner in the event {event_name}. Congratulations! Your outstanding achievement deserves recognition, and we are delighted to award you this honor. Your prize will be delivered to you shortly.\n\nThank you for your participation and dedication.\n\nWarm regards,\nThe Organizing Committee"

def second_prize_body(event_name, username):
    return f"Dear {username},\n\nWe are pleased to announce that you have secured the second prize in the event {event_name}. Congratulations on this remarkable accomplishment! Your hard work and talent have not gone unnoticed. Your prize will be dispatched to you soon.\n\nThank you for being a part of this event.\n\nSincerely,\nThe Organizing Committee"

def third_prize_body(event_name, username):
    return f"Dear {username},\n\nWe are writing to inform you that you have won the third prize in the event {event_name}. Congratulations on this well-deserved recognition! Your dedication and efforts have paid off, and we are honored to award you this prize. Your prize will be sent to you in the coming days.\n\nThank you for your participation and enthusiasm.\n\nKind regards,\nThe Organizing Committee"
